...
public class UserDao implements IUserDao {
	...
	/**
	 * Method : userList 작성자 : PC-17 변경이력 :
	 * 
	...
	public List<User> getUserList() {
		 ...
		 * userList.add(new User("cony")); userList.add(new User("sally"));
		 * 
		 * return userList;
		 */
	}
	...
	/**
	 * Method : getUser 작성자 : PC-17 변경이력 :
	 * 
	 * @param userId
	 * @return Method 설명 :userId를 갖는 사용자 정보 조회
	 */
	@Override
	...
	/**
	 * Method : getUserListOnlyHalf 작성자 : PC-17 변경이력 :
	 * 
	 * @return Method 설명 : 사용자 50명 조회
	 */
	@Override
	...
	/**
	 * Method : getUserPagingList 작성자 : PC-17 변경이력 :
	 * 
	 * @param sqlSession
	 * @param page
	...
	/**
	 * Method : getUserTotalCnt 작성자 : PC-17 변경이력 :
	 * 
	 * @param session
	...
	/**
	 * Method : insertUser 작성자 : PC-17 변경이력 :
	 * 
	 * @param sqlSession
	 * @param user
	...
	/**
	 * Method : deleteUser 작성자 : PC-17 변경이력 :
	 * 
	 * @param sqlSession
	 * @param userId
