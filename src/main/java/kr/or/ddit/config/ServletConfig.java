...
/*
 * <context:annotation-config />는 component-scan에서 true가 기본값이며,
 * java 설정에서는 설정이 불가능하므로 생략
 */
@EnableWebMvc	// <mvc:anootation-driven />과 동일 
public class ServletConfig extends WebMvcConfigurerAdapter {
	...
	*/
	...
	<bean class="org.springframework.web.servlet.view.InternalResourceViewResolver">
		...
		<!-- controller에서 리턴하는 viewName prefix와 suffix가 결합되어서 jsp 경로를 판단
